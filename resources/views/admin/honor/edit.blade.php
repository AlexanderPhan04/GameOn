                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.honor.update', $honorEvent) }}" method="POST">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" id="allow_participant_vote" 
                                           name="allow_participant_vote" value="1" 
                                           {{ old('allow_participant_vote', $honorEvent->allow_participant_vote) ? 'checked' : '' }}>
                                    <label class="form-check-label" for="allow_participant_vote">
                                        <strong>Participant</strong> - Người tham gia
                                    </label>
                                </div>
                            </div>
                            <div class="col-md-6">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label for="participant_weight" class="form-label">Trọng số Participant <span class="text-danger">*</span></label>
                                    <input type="number" class="form-control @error('participant_weight') is-invalid @enderror" 
                                           id="participant_weight" name="participant_weight" 
                                           value="{{ old('participant_weight', $honorEvent->participant_weight) }}" 
                                           step="0.1" min="0.1" max="10" required>
                                    @error('participant_weight')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="alert alert-info">
                                    ...
                                    Ví dụ: 1 vote của Admin (trọng số 2.0) = 2 vote của Participant (trọng số 1.0).
                                </div>
                            </div>
                        </div>

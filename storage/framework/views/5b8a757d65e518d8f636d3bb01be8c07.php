    ...
    <div class="user-card group">
        <div class="flex items-center gap-4">
            ...
            <div class="relative flex-shrink-0">
                <?php if($user->avatar): ?>
                <img src="<?php echo e(Storage::url($user->avatar)); ?>" class="w-12 h-12 rounded-xl object-cover border-2 border-[rgba(0,229,255,0.2)] group-hover:border-[#00E5FF] transition-all">
                <?php else: ?>
                <div class="w-12 h-12 rounded-xl flex items-center justify-center bg-gradient-to-br from-[#000055] to-[#006666] border-2 border-[rgba(0,229,255,0.2)] group-hover:border-[#00E5FF] transition-all">
                    <span class="text-[#00E5FF] font-bold text-lg"><?php echo e(strtoupper(substr($user->display_name, 0, 1))); ?></span>
                </div>
                <?php endif; ?>
            ...
            <div class="flex-1 min-w-0">
                <div class="flex items-center gap-2 mb-1">
                    <h4 class="text-white font-semibold text-sm truncate"><?php echo e($user->display_name); ?></h4>
                ...
                <p class="text-[#94a3b8] text-xs truncate"><?php echo e($user->email); ?></p>
            </div>

            <!-- Status & Date -->
            <div class="hidden sm:flex items-center gap-4">
                <div class="text-right">
                    <p class="text-white text-sm font-medium"><?php echo e($user->created_at->format('d/m/Y')); ?></p>
                    <p class="text-[#94a3b8] text-xs"><?php echo e($user->created_at->format('H:i')); ?></p>
                </div>
            ...
            <!-- Action -->
            <a href="<?php echo e(route('admin.users.index')); ?>?search=<?php echo e($user->email); ?>" class="flex-shrink-0 w-10 h-10 rounded-xl flex items-center justify-center bg-[rgba(0,229,255,0.05)] border border-[rgba(0,229,255,0.2)] text-[#00E5FF] hover:bg-[rgba(0,229,255,0.15)] hover:border-[#00E5FF] hover:shadow-[0_0_15px_rgba(0,229,255,0.3)] transition-all">
...
<?php if($recent_users->hasPages()): ?>
<div class="pt-4 mt-4 border-t border-[rgba(0,229,255,0.1)]">
    <?php echo e($recent_users->links()); ?>

</div>
<?php endif; ?>
<?php /**PATH E:\MarketPlace\resources\views/dashboard/partials/recent-users.blade.php ENDPATH**/ ?>
<?php $__env->startSection('title', __('app.name')); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <section class="relative overflow-hidden" style="margin-top: 64px; height: 85vh; min-height: 750px; max-height: 1300px; width: 100vw; position: relative; left: 50%; right: 50%; margin-left: -50vw; margin-right: -50vw;">
        <div class="absolute inset-0 w-full h-full" style="width: 100vw; height: 100%;">
            <img src="<?php echo e(asset('esp.jpg')); ?>" alt="Esports Community" 
        ...
        <div class="relative z-10 h-full flex items-center justify-center">
            <div class="container mx-auto px-4 text-center">
                <h1 class="text-4xl md:text-6xl lg:text-7xl font-bold mb-4 font-display" style="color: #FFFFFF; text-shadow: 2px 2px 8px rgba(0, 0, 0, 0.8), 0 0 20px rgba(0, 229, 255, 0.6), 0 0 40px rgba(0, 229, 255, 0.4); line-height: 1.2;">
                    <?php echo e(__('app.home.welcome_to')); ?><br>
                    <span style="color: #00E5FF; text-shadow: 0 0 20px rgba(0, 229, 255, 0.8), 0 0 40px rgba(0, 229, 255, 0.6), 0 0 60px rgba(0, 229, 255, 0.4);"><?php echo e(__('app.name')); ?></span>
                </h1>
                <p class="text-lg md:text-xl lg:text-2xl mb-8 font-body max-w-3xl mx-auto px-4" style="color: #FFFFFF; text-shadow: 2px 2px 6px rgba(0, 0, 0, 0.9), 0 0 10px rgba(0, 0, 0, 0.5); line-height: 1.6;">
                    <?php echo e(__('app.home.professional_esports_platform')); ?><br>
                    <?php echo e(__('app.home.join_now_experience_professional_esports')); ?>

                </p>
                <div class="flex justify-center mb-8">
                    <div class="joined-buttons-wrapper">
                        <?php if(auth()->guard()->guest()): ?>
                        <a href="<?php echo e(route('auth.register')); ?>" class="btn-joined-primary">
                            <i class="fas fa-rocket"></i>
                            <span><?php echo e(__('app.home.get_started')); ?></span>
                        </a>
                        <a href="<?php echo e(route('auth.login')); ?>" class="btn-joined-secondary">
                            <i class="fas fa-right-to-bracket"></i>
                            <span><?php echo e(__('app.auth.login')); ?></span>
                        </a>
                        <?php else: ?>
                        <a href="<?php echo e(route('posts.index')); ?>" class="btn-joined-primary" style="border-radius: 9999px;">
        ...
        <div class="container mx-auto px-4">
            <div class="flex flex-wrap justify-center items-center gap-8 lg:gap-12">
                <div class="text-center flex-1 min-w-[150px]">
                    <div class="stat-number"><?php echo e(number_format($stats['total_users'] ?? 0)); ?></div>
                    <p class="text-text-muted text-lg mb-0 font-body mt-2"><?php echo e(__('app.home.registered_gamers')); ?></p>
                </div>
                <div class="text-center flex-1 min-w-[150px]">
                    <div class="stat-number"><?php echo e(number_format($stats['total_teams'] ?? 0)); ?></div>
                    <p class="text-text-muted text-lg mb-0 font-body mt-2"><?php echo e(__('app.home.active_teams')); ?></p>
                </div>
                <div class="text-center flex-1 min-w-[150px]">
                    <div class="stat-number"><?php echo e(number_format($stats['active_tournaments'] ?? 0)); ?></div>
                    <p class="text-text-muted text-lg mb-0 font-body mt-2"><?php echo e(__('app.home.tournaments')); ?></p>
                </div>
                <div class="text-center flex-1 min-w-[150px]">
                    <div class="stat-number">100%</div>
                    <p class="text-text-muted text-lg mb-0 font-body mt-2"><?php echo e(__('app.home.satisfaction')); ?></p>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container mx-auto px-4">
            <div class="text-center mb-20">
                <div class="max-w-3xl mx-auto">
                    <h2 class="text-4xl lg:text-5xl font-bold mb-6 font-display neon-text"><?php echo e(__('app.home.featured_features')); ?></h2>
                    <p class="text-text-muted text-xl mb-0 font-body"><?php echo e(__('app.home.discover_powerful_features')); ?></p>
                </div>
            </div>
            <div class="features-container">
                ...
                <div class="feature-item">
                    <div class="feature-card h-full text-center p-8">
                        ...
                        <h5 class="text-xl font-semibold mb-3 font-display text-text-main"><?php echo e(__('app.home.team_management')); ?></h5>
                        <p class="text-text-muted font-body"><?php echo e(__('app.home.create_manage_teams')); ?></p>
                    </div>
                </div>
                <div class="feature-item">
                    <div class="feature-card h-full text-center p-8">
                        <i class="fas fa-trophy text-neon mb-4 text-5xl" style="filter: drop-shadow(0 0 10px rgba(0, 229, 255, 0.5));"></i>
                        <h5 class="text-xl font-semibold mb-3 font-display text-text-main"><?php echo e(__('app.home.tournament_organization')); ?></h5>
                        <p class="text-text-muted font-body"><?php echo e(__('app.home.organize_tournaments')); ?></p>
                    </div>
                </div>
                <div class="feature-item">
                    <div class="feature-card h-full text-center p-8">
                        <i class="fas fa-chart-line text-neon mb-4 text-5xl" style="filter: drop-shadow(0 0 10px rgba(0, 229, 255, 0.5));"></i>
                        <h5 class="text-xl font-semibold mb-3 font-display text-text-main"><?php echo e(__('app.home.detailed_statistics')); ?></h5>
                        <p class="text-text-muted font-body"><?php echo e(__('app.home.track_performance_rankings')); ?></p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <?php if($stats['featured_tournaments']->count() > 0): ?>
    <section class="py-16 bg-surface">
        <div class="container mx-auto px-4">
            <div class="text-center mb-12">
                <h2 class="text-4xl lg:text-5xl font-bold mb-4 font-display neon-text"><?php echo e(__('app.home.featured_tournaments')); ?></h2>
                <p class="text-xl text-text-muted font-body"><?php echo e(__('app.home.ongoing_upcoming_tournaments')); ?></p>
            </div>
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                <?php $__currentLoopData = $stats['featured_tournaments']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tournament): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="mb-4">
                        ...
                        <div class="p-6">
                            <div class="flex items-center mb-4">
                                <div class="mr-3">
                                    ...
                                    <img src="<?php echo e(Storage::url($tournament->image_url)); ?>" alt="<?php echo e($tournament->name); ?>"
                                ...
                                <div>
                                    <h6 class="mb-1 font-bold text-text-main font-display"><?php echo e($tournament->name); ?></h6>
                                    <small class="text-text-muted font-body"><?php echo e($tournament->game->name ?? 'Unknown Game'); ?></small>
                                </div>
                            </div>
                            <p class="text-text-muted text-sm mb-4 font-body"><?php echo e(Str::limit($tournament->description, 100)); ?></p>
                            <div class="flex justify-between items-center">
                                <span class="px-3 py-1 rounded-full text-sm font-semibold font-display <?php echo e($tournament->status === 'active' ? 'bg-neon/20 text-neon border border-neon/50' : 'bg-yellow-500/20 text-yellow-400 border border-yellow-500/50'); ?>">
            ...
            <div class="text-center mt-10">
                <a href="<?php echo e(route('tournaments.index')); ?>" class="btn-primary-custom font-semibold py-3 px-8 rounded-full font-display inline-block">
                    <i class="fas fa-trophy mr-2"></i><?php echo e(__('app.home.view_all_tournaments')); ?>
    ...
    <!-- Top Teams Section -->
    <?php if($stats['top_teams']->count() > 0): ?>
    <section class="py-16 bg-void">
        <div class="container mx-auto px-4">
            <div class="text-center mb-12">
                <h2 class="text-4xl lg:text-5xl font-bold mb-4 font-display neon-text"><?php echo e(__('app.home.top_teams')); ?></h2>
                <p class="text-xl text-text-muted font-body"><?php echo e(__('app.home.outstanding_popular_teams')); ?></p>
            </div>
            <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
                <?php $__currentLoopData = $stats['top_teams']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $team): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="mb-4">
                    <div class="feature-card h-full text-center">
                        <div class="p-6">
                            <div class="mb-4">
                                <?php if($team->logo): ?>
                                <img src="<?php echo e(Storage::url($team->logo)); ?>" alt="<?php echo e($team->team_name); ?>"
                            ...
                            <h6 class="font-bold mb-2 text-text-main font-display"><?php echo e($team->name); ?></h6>
                            <p class="text-text-muted text-sm mb-3 font-body"><?php echo e(Str::limit($team->description, 60)); ?></p>
                            <div class="flex justify-center items-center">
                                <span class="px-3 py-1 bg-neon/20 text-neon rounded-full text-sm border border-neon/50 font-display">
                                    <i class="fas fa-users mr-1"></i>
                                    <?php echo e($team->active_members_count); ?> thành viên
                                </span>
                            </div>
                        </div>
                    </div>
            ...
            <div class="text-center mt-10">
                <a href="<?php echo e(route('search.view')); ?>" class="btn-primary-custom font-semibold py-3 px-8 rounded-full font-display inline-block">
                    <i class="fas fa-users mr-2"></i><?php echo e(__('app.home.explore_gamers')); ?>
                ...
                <div class="team-card">
                    <div class="flex flex-col items-center text-center">
                        ...
                        <div class="relative mb-3 sm:mb-4">
                            <div class="team-avatar relative" style="border-radius: 50%; padding: 2px; background: linear-gradient(135deg, <?php echo e($member['hover_color']); ?>, transparent, <?php echo e($member['hover_color']); ?>);">
                                <?php if($imageExists): ?>
                                    <img src="<?php echo e($imagePath); ?>" alt="<?php echo e($member['name']); ?>" 
                                ...
                                <?php else: ?>
                                    <div style="width: 100%; height: 100%; border-radius: 50%; background: #1e293b; display: flex; align-items: center; justify-content: center;">
                                        <i class="fas fa-user text-lg sm:text-2xl" style="color: <?php echo e($member['hover_color']); ?>;"></i>
                                    </div>
                                <?php endif; ?>
                            </div>
                            ...
                            <div class="absolute -bottom-1 sm:-bottom-2 left-1/2 transform -translate-x-1/2">
                                <div class="team-role-badge rounded-md sm:rounded-lg font-bold uppercase tracking-wider shadow-lg"
                                     style="background: <?php echo e($member['hover_color']); ?>; color: #000; box-shadow: 0 0 15px <?php echo e($member['hover_shadow']); ?>;">
                        ...
                        <h3 class="team-name font-display font-bold text-white mb-1 sm:mb-2">
                            <?php echo e($member['name'] === 'Alexander Phan' ? 'Phan Nhật Quân' : $member['name']); ?>
                        ...
                        <div class="flex gap-2 sm:gap-3">
                            <a href="#" class="team-social flex items-center justify-center rounded-lg sm:rounded-xl bg-slate-800/30 border border-slate-600/30 text-slate-400 hover:text-white transition-all duration-300" style="--hover-color: <?php echo e($member['hover_color']); ?>;">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\MarketPlace\resources\views/welcome.blade.php ENDPATH**/ ?>
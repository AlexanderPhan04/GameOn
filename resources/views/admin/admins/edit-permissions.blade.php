...
@section('title', 'Chỉnh sửa quyền Admin')
...
<div class="edit-container">
    <div class="max-w-4xl mx-auto px-4 py-6">
        ...
        <form action="{{ route('admin.admins.update-permissions', $user) }}" method="POST">
            @csrf
            @method('PUT')
                ...
                <div class="form-card-body">
                    ...
                    <div class="permissions-grid">
                        @foreach($availablePermissions as $key => $permission)
                            <div class="permission-card {{ in_array($key, old('permissions', $currentPermissions)) ? 'selected' : '' }}"

...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', __('app.name')); ?> - <?php echo e(__('app.tagline')); ?></title>
    
    <!-- SEO Meta Tags -->
    <meta name="description" content="<?php echo $__env->yieldContent('meta_description', 'GameOn - Nền tảng tổ chức giải đấu esport và kết nối gamer Việt Nam. Tạo giải đấu, lập team, tham gia tournament Liên Quân, Valorant, PUBG Mobile miễn phí.'); ?>">
    <meta name="keywords" content="<?php echo $__env->yieldContent('meta_keywords', 'giải đấu esport, tổ chức giải đấu game, nền tảng esport Việt Nam, tạo giải đấu online, quản lý tournament, đăng ký giải đấu game, tìm đội esport, tham gia tournament, lập team chơi game, kết nối gamer Việt Nam, giải đấu game online miễn phí, GameOn esport, giải đấu Liên Quân Mobile, tournament Valorant, giải PUBG Mobile, giải đấu Free Fire'); ?>">
    ...
    <meta property="og:title" content="<?php echo $__env->yieldContent('title', __('app.name')); ?> - <?php echo e(__('app.tagline')); ?>">
    <meta property="og:description" content="<?php echo $__env->yieldContent('meta_description', 'GameOn - Nền tảng tổ chức giải đấu esport và kết nối gamer Việt Nam. Tạo giải đấu, lập team, tham gia tournament miễn phí.'); ?>">
    <meta property="og:image" content="<?php echo e(asset('logo_remove_bg.png')); ?>">
    ...
    <meta name="twitter:title" content="<?php echo $__env->yieldContent('title', __('app.name')); ?> - <?php echo e(__('app.tagline')); ?>">
    <meta name="twitter:description" content="<?php echo $__env->yieldContent('meta_description', 'GameOn - Nền tảng tổ chức giải đấu esport và kết nối gamer Việt Nam.'); ?>">
    <meta name="twitter:image" content="<?php echo e(asset('logo_remove_bg.png')); ?>">
    ...
    <!-- Favicon -->
    <link rel="icon" type="image/png" href="<?php echo e(asset('logo_remove_bg.png')); ?>">
    <link rel="apple-touch-icon" href="<?php echo e(asset('logo_remove_bg.png')); ?>">
...
<body class="<?php echo e(Request::is('chat*') ? 'chat-page' : ''); ?> <?php echo e($showAdminSidebar ? 'has-admin-sidebar' : ''); ?> <?php echo e(Request::is('/') || Request::is('welcome') ? 'welcome-page' : ''); ?>">
    <!-- Loading Screen -->
    <div class="loading-screen" id="loadingScreen">
        <div class="loading-spinner"></div>
        <div class="loading-text"><?php echo e(__('app.common.loading')); ?></div>
    </div>
        ...
        <aside class="admin-sidebar collapsed" id="adminSidebar">
            <div class="sidebar-header">
                <a href="<?php echo e(route('home')); ?>" class="sidebar-brand">
                    <div class="brand-icon">
                        <img src="<?php echo e(asset('logo_remove_bg.png')); ?>" alt="<?php echo e(__('app.name')); ?>" class="w-8 h-8 object-contain">
                    </div>
                </a>
            ...
            <nav class="sidebar-nav">
                <ul class="sidebar-menu">
                    <li class="menu-item <?php echo e(Request::is('dashboard*') ? 'active' : ''); ?>">
                        <a href="<?php echo e(route('dashboard')); ?>" class="menu-link" title="<?php echo e(__('app.nav.dashboard')); ?>">
                            <i class="fas fa-tachometer-alt"></i>
                            <span><?php echo e(__('app.nav.dashboard')); ?></span>
                        </a>
                    </li>
                    <li class="menu-divider"></li>
                    <li class="menu-item has-submenu <?php echo e(Request::is('admin/tournaments*') || Request::is('admin/games*') || Request::is('admin/teams*') || Request::is('admin/users*') || Request::is('admin/honor*') || Request::is('admin/marketplace*') || Request::is('honor*') ? 'open' : ''); ?>" id="managerMenu">
                        <a href="#" class="menu-link" onclick="event.preventDefault(); toggleSubmenu('managerMenu');" title="Manager">
                            <i class="fas fa-briefcase"></i>
                            <span>Manager</span>
                        </a>
                        <ul class="menu-submenu">
                            <li class="menu-item <?php echo e(Request::is('admin/tournaments*') ? 'active' : ''); ?>">
                                <a href="<?php echo e(route('admin.tournaments.index')); ?>" class="menu-link" title="<?php echo e(__('app.profile.manage_tournaments')); ?>">
                                    <i class="fas fa-trophy"></i>
                                    <span><?php echo e(__('app.profile.manage_tournaments')); ?></span>
                                </a>
                            </li>
                            <li class="menu-item <?php echo e(Request::is('admin/games*') ? 'active' : ''); ?>">
                                <a href="<?php echo e(route('admin.games.index')); ?>" class="menu-link" title="<?php echo e(__('app.profile.manage_games')); ?>">
                                    <i class="fas fa-gamepad"></i>
                                    <span><?php echo e(__('app.profile.manage_games')); ?></span>
                                </a>
                            </li>
                            <li class="menu-item <?php echo e(Request::is('admin/teams*') ? 'active' : ''); ?>">
                                <a href="<?php echo e(route('admin.teams.index')); ?>" class="menu-link" title="<?php echo e(__('app.profile.manage_teams')); ?>">
                                    <i class="fas fa-users-cog"></i>
                                    <span><?php echo e(__('app.profile.manage_teams')); ?></span>
                                </a>
                            </li>
                            <li class="menu-item <?php echo e(Request::is('admin/users*') ? 'active' : ''); ?>">
                                <a href="<?php echo e(route('admin.users.index')); ?>" class="menu-link" title="<?php echo e(__('app.profile.manage_users')); ?>">
                                    <i class="fas fa-users"></i>
                                    <span><?php echo e(__('app.profile.manage_users')); ?></span>
                                </a>
                            </li>
                            <?php if(Auth::user()->isSuperAdmin()): ?>
                            <li class="menu-item <?php echo e(Request::is('admin/admins*') ? 'active' : ''); ?>">
                                <a href="<?php echo e(route('admin.admins.index')); ?>" class="menu-link" title="Quản lý Admin">
                                    <i class="fas fa-user-shield"></i>
                                    <span>Quản lý Admin</span>
                                </a>
                            </li>
                            <?php endif; ?>
                            <li class="menu-item <?php echo e(Request::is('admin/honor*') || Request::is('honor*') ? 'active' : ''); ?>">
                                <a href="<?php echo e(route('admin.honor.index')); ?>" class="menu-link" title="<?php echo e(__('app.honor.manage_title')); ?>">
                                    <i class="fas fa-trophy"></i>
                                    <span><?php echo e(__('app.honor.manage_title')); ?></span>
                                </a>
                            </li>
                            <li class="menu-item <?php echo e(Request::is('admin/marketplace*') ? 'active' : ''); ?>">
                                <a href="<?php echo e(route('admin.marketplace.index')); ?>" class="menu-link" title="Quản lý Marketplace">
                    ...
                    <li class="menu-divider"></li>
                    <li class="menu-item <?php echo e(Request::is('admin/system*') || Request::is('admin/settings*') ? 'active' : ''); ?>">
                        <a href="<?php echo e(route('admin.system.settings')); ?>" class="menu-link" title="Setting">
                    ...
                    <li class="menu-divider"></li>
                    <li class="menu-item">
                        <a href="<?php echo e(route('profile.show')); ?>" class="menu-link" title="<?php echo e(__('app.profile.personal_info')); ?>">
                            <i class="fas fa-id-card"></i>
                            <span><?php echo e(__('app.profile.personal_info')); ?></span>
                        </a>
                    </li>
                    <li class="menu-item">
                        <form method="POST" action="<?php echo e(route('auth.logout')); ?>" class="menu-form">
                            <?php echo csrf_field(); ?>
                            <button type="submit" class="menu-link menu-link-logout" title="<?php echo e(__('app.auth.logout')); ?>">
                                <i class="fas fa-sign-out-alt"></i>
                                <span><?php echo e(__('app.auth.logout')); ?></span>
                            </button>
                        </form>
                    </li>
                </ul>
            ...
            <div class="sidebar-footer">
                <div class="sidebar-user-info">
                    <div class="user-avatar">
                        <?php if(Auth::user()->avatar): ?>
                            <img src="<?php echo e(get_avatar_url(Auth::user()->avatar)); ?>" alt="Avatar">
                        <?php else: ?>
                ...
                <div class="language-switcher-sidebar">
                    <div class="relative">
                        <button class="w-full px-3 py-2 text-sm border border-[rgba(0,229,255,0.3)] rounded-lg text-white/90 hover:bg-[rgba(0,229,255,0.1)] hover:border-[#00E5FF] transition-all flex items-center justify-center gap-2" type="button" id="sidebarLanguageToggle" title="<?php echo e(strtoupper(app()->getLocale())); ?>">
                        ...
                        <div class="absolute bottom-full left-0 right-0 mb-2 hidden z-50" id="sidebarLanguageMenu">
                            <div class="bg-[#0d1b2a] border border-[rgba(0,229,255,0.3)] rounded-lg overflow-hidden" style="box-shadow: 0 -10px 40px rgba(0,0,0,0.5), 0 0 15px rgba(0,229,255,0.1);">
                                <a class="language-switch flex items-center gap-3 px-4 py-3 text-white no-underline hover:bg-[rgba(0,229,255,0.15)] transition-all <?php echo e(app()->getLocale() === 'en' ? 'bg-[rgba(0,229,255,0.1)] text-[#00E5FF]' : ''); ?>" href="#" data-locale="en">
                                ...
                                <a class="language-switch flex items-center gap-3 px-4 py-3 text-white no-underline hover:bg-[rgba(0,229,255,0.15)] transition-all <?php echo e(app()->getLocale() === 'vi' ? 'bg-[rgba(0,229,255,0.1)] text-[#00E5FF]' : ''); ?>" href="#" data-locale="vi">
        ...
        <div class="admin-topbar">
            ...
            <div class="topbar-search">
                ...
                <div id="header-search" class="relative">
                    <button type="button" class="px-3 py-1.5 text-sm bg-white text-gray-800 rounded hover:bg-gray-100 transition-colors" id="searchToggle" title="<?php echo e(__('app.search.search')); ?>" aria-expanded="false">
                    ...
                    <div id="searchBox" class="absolute right-0 top-full mt-2" style="display:none; z-index: 100000;">
                        <div class="search-panel">
                            <div class="search-input-wrap">
                                ...
                                <input id="searchInput" class="search-input" placeholder="<?php echo e(__('app.search.search_users_teams_tournaments_games')); ?>" />
                                <div id="searchLoading" class="search-loading"></div>
                                <button id="searchClear" class="search-clear" title="<?php echo e(__('app.search.clear')); ?>"><i class="fas fa-xmark"></i></button>
                                <span class="ml-2 hidden md:inline text-gray-500" title="<?php echo e(__('app.search.shortcut')); ?>"><span class="search-kbd">/</span> <span class="search-kbd">Enter</span></span>
                            </div>
                            <div id="searchResults" class="search-results"></div>
                            <div class="p-2 border-top" id="searchFooter" style="display:none;">
                                <a id="searchSeeAll" class="block w-full px-3 py-1.5 text-sm border border-blue-500 text-blue-500 rounded hover:bg-blue-500 hover:text-white transition-colors text-center"><?php echo e(__('app.search.see_all_results')); ?></a>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <?php else: ?>
        ...
        <nav class="gameon-navbar">
            <div class="container">
                <!-- Brand -->
                <a href="<?php echo e(route('home')); ?>" class="gameon-brand">
                    <div class="gameon-brand-icon">
                        <img src="<?php echo e(asset('logo_remove_bg.png')); ?>" alt="<?php echo e(__('app.name')); ?>" class="w-8 h-8 object-contain">
                    </div>
                    <div class="gameon-brand-text">
                        <div class="gameon-brand-name"><?php echo e(__('app.name')); ?></div>
                        <div class="gameon-brand-tagline"><?php echo e(__('app.tagline')); ?></div>
                    </div>
                </a>
                ...
                <div class="gameon-nav-links hidden lg:flex">
                    <?php if(auth()->guard()->check()): ?>
                        ...
                        <a href="<?php echo e(route('dashboard')); ?>" class="gameon-nav-link">
                            <i class="fas fa-gauge-high"></i>
                            <span><?php echo e(__('app.nav.dashboard')); ?></span>
                        </a>
                        <?php endif; ?>
                        <?php if(Auth::user()->user_role === 'participant'): ?>
                        <a href="<?php echo e(route('teams.index')); ?>" class="gameon-nav-link">
                            <i class="fas fa-users"></i>
                            <span><?php echo e(__('app.nav.my_teams')); ?></span>
                        </a>
                        <?php endif; ?>
                        <a href="<?php echo e(route('chat.index')); ?>" class="gameon-nav-link">
                            <i class="fas fa-comments"></i>
                            <span><?php echo e(__('app.nav.chat')); ?></span>
                        </a>
                        <a href="<?php echo e(route('posts.index')); ?>" class="gameon-nav-link">
                            <i class="fas fa-newspaper"></i>
                            <span><?php echo e(__('app.nav.posts')); ?></span>
                        </a>
                        <a href="<?php echo e(route('marketplace.index')); ?>" class="gameon-nav-link">
                            <i class="fas fa-store"></i>
                            <span>Marketplace</span>
                        </a>
                        <a href="<?php echo e(route('profile.show')); ?>" class="gameon-nav-link">
                            <i class="fas fa-id-card"></i>
                            <span><?php echo e(__('app.profile.personal_info')); ?></span>
                        </a>
                    <?php endif; ?>
                ...
                <div class="gameon-user-menu">
                    ...
                    <div class="relative" id="languageDropdown">
                        <button type="button" class="gameon-nav-link flex items-center gap-2" id="languageDropdownToggle" aria-expanded="false" aria-haspopup="true" title="<?php echo e(strtoupper(app()->getLocale())); ?>" style="border: none; background: none; cursor: pointer; text-decoration: none; padding: 0.5rem 1rem;">
                            <i class="fas fa-globe"></i>
                            <span class="text-sm"><?php echo e(strtoupper(app()->getLocale())); ?></span>
                        </button>
                        <div class="absolute right-0 top-full mt-2 hidden z-[10000]" id="languageDropdownMenu" aria-labelledby="languageDropdownToggle" style="min-width: 150px;">
                            <div class="bg-[#0d1b2a] border border-[rgba(0,229,255,0.3)] rounded-lg overflow-hidden" style="box-shadow: 0 10px 40px rgba(0,0,0,0.5), 0 0 15px rgba(0,229,255,0.1);">
                                <a class="language-switch flex items-center gap-3 px-4 py-3 text-white no-underline transition-all hover:bg-[rgba(0,229,255,0.15)] <?php echo e(app()->getLocale() === 'en' ? 'bg-[rgba(0,229,255,0.1)] text-[#00E5FF]' : ''); ?>" href="#" data-locale="en">
                                    <span class="w-7 h-5 rounded overflow-hidden flex items-center justify-center bg-white text-[10px] font-bold text-blue-600">EN</span>
                                    <span class="flex-1 text-sm font-medium">English</span>
                                    <?php if(app()->getLocale() === 'en'): ?>
                                        <i class="fas fa-check text-[#00E5FF] text-sm"></i>
                                ...
                                <a class="language-switch flex items-center gap-3 px-4 py-3 text-white no-underline transition-all hover:bg-[rgba(0,229,255,0.15)] <?php echo e(app()->getLocale() === 'vi' ? 'bg-[rgba(0,229,255,0.1)] text-[#00E5FF]' : ''); ?>" href="#" data-locale="vi">
                                    <span class="w-7 h-5 rounded overflow-hidden flex items-center justify-center bg-red-600 text-[10px] font-bold text-yellow-300">VI</span>
                                    <span class="flex-1 text-sm font-medium">Tiếng Việt</span>
                                    <?php if(app()->getLocale() === 'vi'): ?>
                                        <i class="fas fa-check text-[#00E5FF] text-sm"></i>
                    ...
                    <div class="relative" id="userMenuDropdown">
                        <a href="#" class="gameon-nav-link" id="userMenuToggle" style="text-decoration: none;">
                            ...
                            <div class="gameon-user-info hidden lg:block">
                                <div class="gameon-user-name"><?php echo e(Auth::user()->name ?? 'User'); ?></div>
                                <div class="gameon-user-role"><?php echo e(ucfirst(str_replace('_', ' ', Auth::user()->user_role ?? 'user'))); ?></div>
                            </div>
                        ...
                        <ul class="absolute right-0 top-full mt-2 hidden bg-[#0d1b2a] border border-[rgba(0,229,255,0.2)] rounded-lg py-2 min-w-[200px] z-[10000] shadow-lg" id="userMenuDropdownMenu">
                            <?php if(Auth::user()->user_role === 'participant'): ?>
                            <li class="list-none">
                                <a href="<?php echo e(route('teams.index')); ?>" class="gameon-dropdown-item">
                                    <i class="fas fa-users"></i>
                                    <span><?php echo e(__('app.nav.my_teams')); ?></span>
                                </a>
                            </li>
                            <?php endif; ?>
                            <?php if(Auth::user()->user_role === 'admin' || Auth::user()->user_role === 'super_admin'): ?>
                            <li class="list-none">
                                <a href="<?php echo e(route('admin.games.index')); ?>" class="gameon-dropdown-item">
                                    <i class="fas fa-gamepad"></i>
                                    <span><?php echo e(__('app.profile.manage_games')); ?></span>
                                </a>
                            </li>
                            <li class="list-none">
                                <a href="<?php echo e(route('admin.tournaments.index')); ?>" class="gameon-dropdown-item">
                                    <i class="fas fa-trophy"></i>
                                    <span><?php echo e(__('app.profile.manage_tournaments')); ?></span>
                                </a>
                            </li>
                            <li class="list-none">
                                <a href="<?php echo e(route('admin.teams.index')); ?>" class="gameon-dropdown-item">
                                    <i class="fas fa-users-gear"></i>
                                    <span><?php echo e(__('app.profile.manage_teams')); ?></span>
                                </a>
                            </li>
                            <li class="list-none">
                                <a href="<?php echo e(route('admin.users.index')); ?>" class="gameon-dropdown-item">
                                    <i class="fas fa-users"></i>
                                    <span><?php echo e(__('app.profile.manage_users')); ?></span>
                                </a>
                            </li>
                            <?php if(Auth::user()->isSuperAdmin()): ?>
                            <li class="list-none">
                                <a href="<?php echo e(route('admin.admins.index')); ?>" class="gameon-dropdown-item">
                                    <i class="fas fa-user-shield"></i>
                                    <span>Quản lý Admin</span>
                                </a>
                            </li>
                    ...
                    <a href="<?php echo e(route('auth.login')); ?>" class="gameon-nav-link hidden lg:flex">
                        <i class="fas fa-sign-in-alt"></i>
                        <span><?php echo e(__('app.auth.login')); ?></span>
                    </a>
                    <a href="<?php echo e(route('auth.register')); ?>" class="gameon-nav-link hidden lg:flex" style="background: rgba(0, 229, 255, 0.1); border: 1px solid rgba(0, 229, 255, 0.3);">
                        <i class="fas fa-user-plus"></i>
                        <span><?php echo e(__('app.auth.register')); ?></span>
                    </a>
                    <?php endif; ?>
        ...
        <div class="mobile-slide-menu" id="mobileSlideMenu">
            ...
            <div class="mobile-menu-header">
                <div class="mobile-menu-brand">
                    <img src="<?php echo e(asset('logo_remove_bg.png')); ?>" alt="<?php echo e(__('app.name')); ?>" class="w-10 h-10 object-contain">
                    <div>
                        <div class="text-white font-bold text-lg"><?php echo e(__('app.name')); ?></div>
                        <div class="text-slate-400 text-xs"><?php echo e(__('app.tagline')); ?></div>
                    </div>
                </div>
            ...
            <div class="mobile-menu-content">
                ...
                <div class="mobile-user-info">
                    ...
                    <div class="mobile-user-details">
                        <div class="mobile-user-name"><?php echo e(Auth::user()->name ?? 'User'); ?></div>
                        <div class="mobile-user-role"><?php echo e(ucfirst(str_replace('_', ' ', Auth::user()->user_role ?? 'user'))); ?></div>
                    </div>
                </div>
                ...
                <nav class="mobile-menu-nav">
                    <a href="<?php echo e(route('home')); ?>" class="mobile-menu-item <?php echo e(Request::is('/') || Request::is('home') ? 'active' : ''); ?>">
                        <i class="fas fa-home"></i>
                        <span>Trang chủ</span>
                    </a>
                    <a href="<?php echo e(route('dashboard')); ?>" class="mobile-menu-item <?php echo e(Request::is('dashboard*') ? 'active' : ''); ?>">
                        <i class="fas fa-gauge-high"></i>
                        <span><?php echo e(__('app.nav.dashboard')); ?></span>
                    </a>
                    <?php if(Route::has('tournaments.index')): ?>
                    <a href="<?php echo e(route('tournaments.index')); ?>" class="mobile-menu-item <?php echo e(Request::is('tournaments*') ? 'active' : ''); ?>">
                        <i class="fas fa-trophy"></i>
                        <span><?php echo e(__('app.nav.tournaments')); ?></span>
                    </a>
                    <?php endif; ?>
                    <?php if(Auth::user()->user_role === 'participant' && Route::has('teams.index')): ?>
                    <a href="<?php echo e(route('teams.index')); ?>" class="mobile-menu-item <?php echo e(Request::is('teams*') ? 'active' : ''); ?>">
                        <i class="fas fa-users"></i>
                        <span><?php echo e(__('app.nav.my_teams')); ?></span>
                    </a>
                    <?php endif; ?>
                    <?php if(Route::has('chat.index')): ?>
                    <a href="<?php echo e(route('chat.index')); ?>" class="mobile-menu-item <?php echo e(Request::is('chat*') ? 'active' : ''); ?>">
                        <i class="fas fa-comments"></i>
                        <span><?php echo e(__('app.nav.chat')); ?></span>
                    </a>
                    <?php endif; ?>
                    <?php if(Route::has('posts.index')): ?>
                    <a href="<?php echo e(route('posts.index')); ?>" class="mobile-menu-item <?php echo e(Request::is('posts*') ? 'active' : ''); ?>">
                        <i class="fas fa-newspaper"></i>
                        <span><?php echo e(__('app.nav.posts')); ?></span>
                    </a>
                    <?php endif; ?>
                    <?php if(Route::has('marketplace.index')): ?>
                    <a href="<?php echo e(route('marketplace.index')); ?>" class="mobile-menu-item <?php echo e(Request::is('marketplace*') ? 'active' : ''); ?>">
                        <i class="fas fa-store"></i>
                        <span>Marketplace</span>
                    </a>
                    <?php endif; ?>
                    <?php if(Route::has('profile.show')): ?>
                    <a href="<?php echo e(route('profile.show')); ?>" class="mobile-menu-item <?php echo e(Request::is('profile*') ? 'active' : ''); ?>">
                        <i class="fas fa-id-card"></i>
                        <span><?php echo e(__('app.profile.personal_info')); ?></span>
                    </a>
                    <?php endif; ?>
                ...
                <nav class="mobile-menu-nav">
                    <a href="<?php echo e(route('admin.games.index')); ?>" class="mobile-menu-item">
                        <i class="fas fa-gamepad"></i>
                        <span><?php echo e(__('app.profile.manage_games')); ?></span>
                    </a>
                    <a href="<?php echo e(route('admin.tournaments.index')); ?>" class="mobile-menu-item">
                        <i class="fas fa-trophy"></i>
                        <span><?php echo e(__('app.profile.manage_tournaments')); ?></span>
                    </a>
                    <a href="<?php echo e(route('admin.teams.index')); ?>" class="mobile-menu-item">
                        <i class="fas fa-users-gear"></i>
                        <span><?php echo e(__('app.profile.manage_teams')); ?></span>
                    </a>
                    <a href="<?php echo e(route('admin.users.index')); ?>" class="mobile-menu-item">
                        <i class="fas fa-users"></i>
                        <span><?php echo e(__('app.profile.manage_users')); ?></span>
                    </a>
                    <?php if(Auth::user()->isSuperAdmin()): ?>
                    <a href="<?php echo e(route('admin.admins.index')); ?>" class="mobile-menu-item">
                        <i class="fas fa-user-shield"></i>
                        <span>Quản lý Admin</span>
                    </a>
                    <?php endif; ?>
                ...
                <div class="mobile-language-switcher">
                    <a href="#" class="mobile-lang-btn language-switch <?php echo e(app()->getLocale() === 'vi' ? 'active' : ''); ?>" data-locale="vi">
                        <i class="fas fa-flag"></i> VI
                    </a>
                    <a href="#" class="mobile-lang-btn language-switch <?php echo e(app()->getLocale() === 'en' ? 'active' : ''); ?>" data-locale="en">
                ...
                <!-- Logout -->
                <form method="POST" action="<?php echo e(route('auth.logout')); ?>" class="mobile-logout-form">
                    <?php echo csrf_field(); ?>
                ...
                <!-- Guest Menu -->
                <nav class="mobile-menu-nav">
                    <a href="/" class="mobile-menu-item <?php echo e(Request::is('/') ? 'active' : ''); ?>">
                        <i class="fas fa-home"></i>
                        <span>Trang chủ</span>
                    </a>
                    <?php if(Route::has('tournaments.index')): ?>
                ...
                <div class="mobile-auth-buttons">
                    <?php if(Route::has('auth.login')): ?>
                    <a href="<?php echo e(route('auth.login')); ?>" class="mobile-auth-btn mobile-login-btn">
                        <i class="fas fa-sign-in-alt"></i>
                        <span><?php echo e(__('app.auth.login')); ?></span>
                    </a>
                    <?php endif; ?>
                    <?php if(Route::has('auth.register')): ?>
                    <a href="<?php echo e(route('auth.register')); ?>" class="mobile-auth-btn mobile-register-btn">
                        <i class="fas fa-user-plus"></i>
                        <span><?php echo e(__('app.auth.register')); ?></span>
                    </a>
                    <?php endif; ?>
    ...
    <!-- Main Content -->
    <main class="content-wrapper <?php echo e($showAdminSidebar ? 'content-wrapper-with-sidebar' : ''); ?>">
            ...
            <div style="max-width: 1200px; margin: 0 auto; padding: 0 24px; position: relative; z-index: 10;">
                ...
                <div style="display: grid; grid-template-columns: repeat(4, 1fr); gap: 48px; margin-bottom: 48px;">
                    ...
                    <div>
                        <div style="display: flex; align-items: center; gap: 12px; margin-bottom: 20px;">
                            <img src="<?php echo e(asset('logo_remove_bg.png')); ?>" alt="<?php echo e(__('app.name')); ?>" style="width: 48px; height: 48px; object-fit: contain;">
                        ...
                        <p style="color: #94a3b8; font-size: 14px; line-height: 1.6; margin-bottom: 24px;">
                            <?php echo e(__('app.footer.professional_esports_management_platform')); ?>
                    ...
                    <div>
                        <h3 style="font-family: 'Rajdhani', sans-serif; font-weight: 700; color: white; font-size: 18px; text-transform: uppercase; letter-spacing: 0.1em; margin-bottom: 24px; padding-left: 16px; border-left: 3px solid #00E5FF;">
                            <?php echo e(__('app.footer.features')); ?>

                        </h3>
                        <ul style="list-style: none; padding: 0; margin: 0;">
                            <li style="margin-bottom: 12px;">
                                <a href="<?php echo e(route('tournaments.index')); ?>" style="color: #94a3b8; text-decoration: none; font-size: 14px; transition: color 0.3s ease; display: flex; align-items: center; gap: 8px;">
                                    <span style="color: #00E5FF;">›</span> <?php echo e(__('app.nav.tournaments')); ?>

                                </a>
                            </li>
                            <li style="margin-bottom: 12px;">
                                <a href="<?php echo e(route('teams.index')); ?>" style="color: #94a3b8; text-decoration: none; font-size: 14px; transition: color 0.3s ease; display: flex; align-items: center; gap: 8px;">
                                    <span style="color: #00E5FF;">›</span> <?php echo e(__('app.nav.my_teams')); ?>

                                </a>
                            </li>
                            <li style="margin-bottom: 12px;">
                                <a href="<?php echo e(route('chat.index')); ?>" style="color: #94a3b8; text-decoration: none; font-size: 14px; transition: color 0.3s ease; display: flex; align-items: center; gap: 8px;">
                                    <span style="color: #00E5FF;">›</span> <?php echo e(__('app.nav.chat')); ?>
                    ...
                    <div>
                        <h3 style="font-family: 'Rajdhani', sans-serif; font-weight: 700; color: white; font-size: 18px; text-transform: uppercase; letter-spacing: 0.1em; margin-bottom: 24px; padding-left: 16px; border-left: 3px solid #00E5FF;">
                            <?php echo e(__('app.footer.support')); ?>
                        ...
                        <ul style="list-style: none; padding: 0; margin: 0;">
                            <li style="margin-bottom: 12px;">
                                <a href="#" style="color: #94a3b8; text-decoration: none; font-size: 14px; transition: color 0.3s ease; display: flex; align-items: center; gap: 8px;">
                                    <span style="color: #00E5FF;">›</span> <?php echo e(__('app.footer.help_center')); ?>

                                </a>
                            </li>
                            <li style="margin-bottom: 12px;">
                                <a href="#" style="color: #94a3b8; text-decoration: none; font-size: 14px; transition: color 0.3s ease; display: flex; align-items: center; gap: 8px;">
                                    <span style="color: #00E5FF;">›</span> <?php echo e(__('app.footer.contact')); ?>

                                </a>
                            </li>
                            <li style="margin-bottom: 12px;">
                                <a href="#" style="color: #94a3b8; text-decoration: none; font-size: 14px; transition: color 0.3s ease; display: flex; align-items: center; gap: 8px;">
                                    <span style="color: #00E5FF;">›</span> <?php echo e(__('app.footer.bug_report')); ?>

                                </a>
                            </li>
                            <li style="margin-bottom: 12px;">
                                <a href="#" style="color: #94a3b8; text-decoration: none; font-size: 14px; transition: color 0.3s ease; display: flex; align-items: center; gap: 8px;">
                                    <span style="color: #00E5FF;">›</span> <?php echo e(__('app.footer.faq')); ?>
                    ...
                    <div>
                        <h3 style="font-family: 'Rajdhani', sans-serif; font-weight: 700; color: white; font-size: 18px; text-transform: uppercase; letter-spacing: 0.1em; margin-bottom: 24px; padding-left: 16px; border-left: 3px solid #00E5FF;">
                            <?php echo e(__('app.footer.connect')); ?>

                        </h3>
                        <p style="color: #94a3b8; font-size: 14px; margin-bottom: 16px;"><?php echo e(__('app.footer.subscribe_newsletter')); ?></p>
                        
                        <form style="display: flex; gap: 8px; margin-bottom: 20px;">
                            <input type="email" placeholder="<?php echo e(__('app.footer.your_email')); ?>" 
                ...
                <div style="border-top: 1px solid rgba(0, 229, 255, 0.1); padding-top: 24px; display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap; gap: 16px;">
                    <div style="color: #64748b; font-size: 13px;">
                        &copy; <?php echo e(date('Y')); ?> <span style="color: white; font-weight: 600;">Game On</span>. All rights reserved.
                    </div>
                    <div style="display: flex; gap: 24px;">
                        <a href="#" style="color: #64748b; text-decoration: none; font-size: 13px; transition: color 0.3s ease;"><?php echo e(__('app.footer.terms_of_service')); ?></a>
                        <a href="#" style="color: #64748b; text-decoration: none; font-size: 13px; transition: color 0.3s ease;"><?php echo e(__('app.footer.privacy_policy')); ?></a>
                        <a href="#" style="color: #64748b; text-decoration: none; font-size: 13px; transition: color 0.3s ease;"><?php echo e(__('app.footer.cookie_policy')); ?></a>
                    </div>
    ...
    <?php else: ?>
        ...
        <?php if(Request::is('/') || Request::is('welcome')): ?>
                ...
                <div class="container mx-auto px-6 relative z-10">
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
                        ...
                        <div>
                            ...
                            <ul class="space-y-3">
                                <li>
                                    <a href="<?php echo e(route('tournaments.index')); ?>" class="text-white hover:text-neon transition-colors flex items-center gap-2">
                                        <i class="fas fa-angle-right text-xs text-slate-400"></i>
                                        <?php echo e(__('app.nav.tournaments')); ?>

                                    </a>
                                </li>
                                <li>
                                    <a href="<?php echo e(route('teams.index')); ?>" class="text-white hover:text-neon transition-colors flex items-center gap-2">
                                        <i class="fas fa-angle-right text-xs text-slate-400"></i>
                                        <?php echo e(__('app.nav.my_teams')); ?>

                                    </a>
                                </li>
                                <li>
                                    <a href="<?php echo e(route('chat.index')); ?>" class="text-white hover:text-neon transition-colors flex items-center gap-2">
                                        <i class="fas fa-angle-right text-xs text-slate-400"></i>
                                        <?php echo e(__('app.nav.chat')); ?>
                            ...
                            <ul class="space-y-3">
                                <li>
                                    <a href="#" class="text-white hover:text-neon transition-colors">
                                        <?php echo e(__('app.footer.help_center')); ?>

                                    </a>
                                </li>
                                <li>
                                    <a href="#" class="text-white hover:text-neon transition-colors">
                                        <?php echo e(__('app.footer.contact')); ?>

                                    </a>
                                </li>
                                <li>
                                    <a href="#" class="text-white hover:text-neon transition-colors">
                                        <?php echo e(__('app.footer.bug_report')); ?>

                                    </a>
                                </li>
                                <li>
                                    <a href="#" class="text-white hover:text-neon transition-colors">
                                        <?php echo e(__('app.footer.faq')); ?>
                        ...
                        <div>
                            ...
                            <p class="text-sm mb-4 text-white"><?php echo e(__('app.footer.subscribe_newsletter')); ?></p>
                    ...
                    <div class="border-t border-border pt-8 pb-8 flex flex-row flex-wrap justify-between items-center gap-4 text-xs text-white">
                        <div>
                            &copy; <?php echo e(date('Y')); ?> <span class="font-bold">Game On</span>. All rights reserved.
                            </div>
                        <div class="flex gap-6">
                            <a href="#" class="hover:text-white transition-colors"><?php echo e(__('app.footer.terms_of_service')); ?></a>
                            <a href="#" class="hover:text-white transition-colors"><?php echo e(__('app.footer.privacy_policy')); ?></a>
                            <a href="#" class="hover:text-white transition-colors"><?php echo e(__('app.footer.cookie_policy')); ?></a>
                        </div>
        ...
        (function(){
            ...
            input && input.addEventListener('keydown', function(e){
                if(e.key === 'Enter'){
                    ...
                    if(q){ window.location.href = `<?php echo e(route('search.view')); ?>?q=${encodeURIComponent(q)}`; }
                }
            });
            ...
            function renderResults(data){
                const i18n = {
                    users: "<?php echo e(__('app.search.users')); ?>",
                    teams: "<?php echo e(__('app.search.teams')); ?>",
                    tournaments: "<?php echo e(__('app.search.tournaments')); ?>",
                    games: "<?php echo e(__('app.search.games')); ?>",
                    empty: "<?php echo e(__('app.search.no_results_found')); ?>"
                };
                const html =
                ...
                if(footer && seeAll){
                    ...
                    seeAll.setAttribute('href', `<?php echo e(route('search.view')); ?>?q=${encodeURIComponent(q)}`);
                }
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            languageSwitches.forEach(function(switchElement) {
                switchElement.addEventListener('click', function(e) {
                    ...
                    fetch('<?php echo e(route("language.switch")); ?>', {
                        method: 'POST',
                        headers: {
...
</html><?php /**PATH E:\MarketPlace\resources\views/layouts/app.blade.php ENDPATH**/ ?>